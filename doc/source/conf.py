...
copyright = '%s, OpenStack Glance Team' % datetime.date.today().year
...
texinfo_documents = [
  ('index', 'Glance-specs', 'Glance Design Specs',
   'OpenStack Glance Team', 'glance-specs',
   'Design specifications for the Glance project.', 'Miscellaneous'),
]
